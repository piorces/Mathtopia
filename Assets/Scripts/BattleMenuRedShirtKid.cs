...
public class BattleMenuRedShirtKid : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (numOfRounds == 3)
        {
            ...
            if(numRoundsWonPlayer > numRoundsWonOpponent)
            {
                ...
                Debug.Log("YOU Win");
                movementScript.GetComponent<BattleMenuRedShirtKid>().enabled = false;
                movementScript.GetComponent<BattleMenuYellowHairKid>().enabled = true;
            }
            else
            {
                movementScript.speed = 5;
    ...
    {
        if (collision.gameObject.tag == "redKid" && movementScript.GetComponent<BattleMenuRedShirtKid>().enabled == true)
        {
