...
public class BattleMenuFarmer : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            else
            {
                ...
                if (playerTurn == true && timeRemaining == 0)
                {
                    ...
                    if (winSquarePlayer1.GetComponent<RawImage>().color == Color.white)
                    {
                        ...
                        timeRemaining = 10;
                        timerIsRunning = true;
                        timeForWaiting = Random.Range(3, 8);
        ...
        if (numOfRounds == 3)
        {
            ...
            if(numRoundsWonPlayer > numRoundsWonOpponent)
            {
                ...
                Debug.Log("YOU Win");
                movementScript.GetComponent<BattleMenuFarmer>().enabled = false;
            }
            else
            {
                movementScript.speed = 5;
    ...
    {
        if (collision.gameObject.tag == "Farmer" && int.Parse(keyText.text) == 2 && movementScript.GetComponent<BattleMenuFarmer>().enabled == true)
        {
